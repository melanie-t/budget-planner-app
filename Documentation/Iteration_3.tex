...
\noindent{\bf Alternate Flow 3 - Negative Balance}\\
...
\noindent{\bf Alternate Flow 1 - No Account}\\
...
\noindent{\bf Alternate Flow 1 - Invalid Date Format}\\
...
\noindent{\bf Alternate Flow 1 - No Transaction}\\
...
\noindent{\bf Alternate Flow 3 - Negative Amount}\\
...
\noindent{\bf Alternate Flow 1 - No Budget}\\
...
% Describe/include test data from output files.
\end{document}
